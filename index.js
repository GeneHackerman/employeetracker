...
const promptMessages = {
    ...
    viewByDepartment: "View All Employees by Deparment",
...
function viewByManager() {
    const query = `SELECT CONCAT(manager.fist_name, '', manager.last_name) AS manager, department.name AS department, employee.id, employee.first_name, employee.last_name, role.title
    FROM employee
    LEFT JOIN employee manager ON manager.id = employee.manager_id
    ...
    inquirer.prompt([
        {
            name: "action",
            type: "list",
            message: "In order to proceed with an employee, an ID must be entered. View all employees to get" +
